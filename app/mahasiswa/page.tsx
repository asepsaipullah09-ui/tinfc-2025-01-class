    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-slate-600 mb-1">Cari Email</label>
            <input
              type="text"
              value={searchEmail}
        ...
        {hasActiveFilters && (
          <div className="mt-4 p-3 bg-blue-50 rounded-lg">
            <p className="text-sm text-blue-700">
              Menampilkan <span className="font-bold">{filteredMahasiswa.length}</span> dari <span className="font-bold">{mahasiswa.length}</span> data mahasiswa
            </p>
          </div>
        )}
      </div>
      ...
      <div className="hidden md:block bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        ...
        {filteredMahasiswa.length === 0 && !hasActiveFilters && mahasiswa.length === 0 && (
          <div className="text-center py-12 text-slate-500">
            <svg className="w-16 h-16 mx-auto mb-4 text-slate-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
